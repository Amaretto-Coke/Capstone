...
import traceback
from SetUpOld import *
from GraphicsOld import *
...
if __name__ == '__main__':
    ...
    try:
        ...
        geo_prop_df, num_nodes = create_cyl_nodes(rings=inputs['rings'],
        ...
        for t in time_steps[:-1]:
            print('\rCurrently on timestep {0} of {1}.'.format(int(t/inputs['TimeStep[s]'])+1, total_time_steps),
                  end='', flush=True)
            for n in nodes:
        ...
        output = 'Old ' + str(num_nodes) + ' ' + str(total_time_steps) + ' ' + str(iteration_seconds) + '\n'
        print(output)
